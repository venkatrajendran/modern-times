    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#/">
                        ...
                        if($panelInit->settingsArray['siteLogo'] == "siteName"){
                            ?>
                            <span>
                                <span class="dark-logo" ng-show="$root.dashboardData.baseUser.defTheme.indexOf('dark') == -1"><img src="http://modern-times.in/dev/logo/logo.png" alt"<?php echo $panelInit->settingsArray['siteTitle']; ?>"/></span>
                                <span class="light-logo" ng-show="$root.dashboardData.baseUser.defTheme.indexOf('dark') !== -1"><img src="http://modern-times.in/dev/logo/logo.png" alt"<?php echo $panelInit->settingsArray['siteTitle']; ?>"/></span>
                            </span>
                            <?php
        ...
        <aside class="left-sidebar <?php if($panelInit->settingsArray['leftmenuScroller'] == "e"){ echo "enableSlimScroller"; } ?> no-print" style="padding-bottom:60px;">
            ...
            <div class="scroll-sidebar" >
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div style="display:none;" class="profile-img"> <img src="{{URL::to('/dashboard/profileImage/'.$users['id'])}}" alt="user" /> </div>
                    <!-- User profile text-->
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer" <?php if($panelInit->settingsArray['leftmenuScroller'] != "e"){ ?> style='position:fixed !important;' <?php } ?>>
                <?php //echo $panelInit->settingsArray['footer']; ?>Powered by Moderntimes Technology & Services
            </footer>
        </div>
