                ...
                <form class="form-horizontal form-material" id="loginform" action="{{URL::to('/login')}}" method="post">
                    <a href="javascript:void(0)" class="text-center db logo-text-login">
                        ...
                        if($panelInit->settingsArray['siteLogo'] == "siteName"){
                            ...
                            ?><img src="http://modern-times.in/dev/logo/logo.png<?php echo URL::asset('assets/images/logo-light.png'); ?>"  /><?php
                        }
                        /
                        */?>
                        <img src="http://modern-times.in/dev/logo/logo_old.png"/>
                    </a>
                    ...
                    <div>
                    <!--<img src="http://modern-times.in/dev/logo/logo_mo.png" style="max-width: 120px;margin-left: 34%;"/>-->
                    </div>
                </form>
            </div>
