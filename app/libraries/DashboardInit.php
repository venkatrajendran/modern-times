	...
	public function __construct(){
		$this->panelItems = array(
								...
								/*	"examslist"=>array("title"=>"examsList","url"=>URL::to('#/examsList'),"icon"=>"mdi mdi-playlist-check","cusPerm"=>"examsList","permissions"=>array('admin','teacher','student','parent') ), */
									...
									"accounting"=>array("title"=>"accounting","icon"=>"mdi mdi-currency-inr","activated"=>"paymentsAct","cusPerm"=>"accounting","permissions"=>array('admin','student','parent','account'),
														"children"=>array(
									...
									"expensesList"=>array("title"=>"Expenses","icon"=>"mdi mdi-currency-inr","activated"=>"paymentsAct","cusPerm"=>"accounting","permissions"=>array('admin','account'),
														"children"=>array(
