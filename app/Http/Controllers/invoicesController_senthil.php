...
//$sname = "testdd";
                    ...
                    $msg = "Dear " . $parents1[0]->fullName . ", Thanks for " . \Input::get('paymentDescription') . " payment of INR " . $paid_amount . " for your Kid " . $student1[0]->fullName . ". Remaining Balance: " . $r_amount . " Regards, PSV Polytechnic College";
